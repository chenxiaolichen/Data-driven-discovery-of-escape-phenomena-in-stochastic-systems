...
savedir='./met_inverse_driftpara_weight_10_decay200005e-3_50w_random_ran_duiqi_300dounda'
    ...
    for i in range(500000+1):
        ...
        if i % 1000 == 0:
            ...
            if temp_loss<min_loss:
                ...
                i_opt=i
                save_path = saver.save(sess, savedir + '/metinver_driftpara_best_model_10_decay200005e-3_50w_random_ran_duiqi_300dounda.ckpt')
                ...
                file_name = './met_inverse_driftpara_weight_10_decay200005e-3_50w_random_ran_duiqi_300dounda/metinver_driftpara_hyper_best_model_10_decay200005e-3_50w_random_ran_duiqi_300dounda.pkl'
...
plt.legend()
plt.grid(True)
plt.savefig('para1_1_420_decay200005e3-10ep50w_random_ran_duiqi_300dounda.png')


np.savetxt('param_recorddecay200005e3-10ep50w_random_ran_duiqi_300dounda.txt',para1_history)
...
plt.legend()
plt.grid(True)
#plt.savefig('para2_1_420_5e3-300ep30w_random_ran_duiqi.png')
