...
u_opt=np.loadtxt('./101-ut0-ep.txt')
N_ob=5
...
savedir='./ep_inverse_driftpara_weight5'
import pickle
    ...
    for i in range(25000+1):
        ...
        if i % 1000 == 0:
            ...
            if temp_loss<min_loss:
                ...
                save_path = saver.save(sess, savedir + '/epinver_driftpara_best_model5.ckpt')
                ...
                file_name = './ep_inverse_driftpara_weight5/epinver_driftpara_hyper_best_model5.pkl'
...
# plt.xlabel('x')
# plt.ylabel('EP_inverse_driftpara')
# plt.legend(['predicted solution','true solution'] ,frameon=False)
# plt.title('Genetic regulatory system EP_inverse_driftpara')
# plt.show()