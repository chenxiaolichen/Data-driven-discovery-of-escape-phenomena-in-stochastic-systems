...
savedir='./met_inverse_driftparam_weight_30w_10_5e-4_nondecay-420-100'
para1_record = []
    ...
    for i in range(300000+1):
        ...
        if i % 1000 == 0:
            ...
            if temp_loss<min_loss:
                ...
                i_opt=i
                save_path = saver.save(sess, savedir + '/metinver_driftpara_best_model_30w_10_5e-4_nondecay-420-100.ckpt')
                ...
                file_name = './met_inverse_driftparam_weight_30w_10_5e-4_nondecay-420-100/metinver_driftpara_hyper_best_model_30w_10_5e-4_nondecay-420-100.pkl'
...
#
# plt.savefig('param_30w_10_5e-4_nondecay-420-100.png')
#
# np.savetxt('param_record_30w_10_5e-4_nondecay-420-100.txt',para1_record)
