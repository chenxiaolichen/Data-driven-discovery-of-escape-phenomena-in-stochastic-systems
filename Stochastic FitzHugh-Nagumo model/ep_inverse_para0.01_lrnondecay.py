...
observations = np.hstack((X_obs, Y_obs, u_ob))
#
np.savetxt('observations_60-100.txt', observations, delimiter=',', header='X,Y,u')
...
loss =loss_f+100*loss_ob+100*loss_boundary
# # loss =loss_f+loss_ob
optimizer_Adam = tf.train.AdamOptimizer(5e-4) #1e-3
train_op_Adam = optimizer_Adam.minimize(loss)


min_loss = 1e16
saver = tf.train.Saver(max_to_keep=1000)
savedir='./ep_inverse_driftpara_weight_30w_60_5e-4_nondecay-100'
    ...
    for i in range(300000+1):
        ...
        if i % 1000 == 0:
            ...
            if temp_loss<min_loss:
                ...
                i_opt=i
                save_path = saver.save(sess, savedir + '/epinver_driftpara_best_model_30w_60_5e-4_nondecay-100.ckpt')
                ...
                file_name = './ep_inverse_driftpara_weight_30w_60_5e-4_nondecay-100/epinver_driftpara_hyper_best_model_30w_60_5e-4_nondecay-100.pkl'
...
#
# plt.savefig('para1.05_30w_50_5e-3_nondecay-no100-420.png')
#
# np.savetxt('para1.05_record_30w_50_5e-3_decay2000-100.txt',para1_record)
...
plt.savefig('para0.01_30w_60_5e-4_nondecay-100.png')

np.savetxt('para0.01_record_30w_60_5e-4_nondecay-100.txt',para2_record)
