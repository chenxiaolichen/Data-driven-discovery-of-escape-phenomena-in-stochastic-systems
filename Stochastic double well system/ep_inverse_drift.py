...
xf1 = np.reshape(np.linspace(x0,x1,21),[-1,1])

xf_tf = tf.to_double(xf1)

f_target = f_exact(xf1)
    ...
    for i in range(100000+1):
        ...
        if i % 1000 == 0:
            ...
            if temp_loss<min_loss:
                ...
                i_opt=i
                save_path = saver.save(sess, savedir + '/epinver_drift_best_model.ckpt')
                ...
                file_name = './ep_inverse_drift_weight/epinver_drift_hyper_best_model.pkl'
...
# plt.title('Escape Probability')
# plt.savefig('ep_inverdrift.png')
# plt.show()